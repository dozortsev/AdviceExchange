...
CREATE TABLE user (
  ...
  UNIQUE (user_id, user_email, user_password)
);
...
CREATE TABLE comment (
  ...
  cm_id          BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
  cm_user_id     INT               NOT NULL,
  cm_question_id INT               NOT NULL,
  cm_content     LONGVARCHAR(1000) NOT NULL,
...
CREATE TABLE badge (
  ...
  bdg_id   BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
...
CREATE TABLE user_badge (
  ...
  ub_badge_id BIGINT NOT NULL,
  ub_user_id  BIGINT NOT NULL
);
...
CREATE TABLE answer (
  ...
  asw_id          BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
  asw_user_id     INT                   NOT NULL,
  asw_question_id INT                   NOT NULL,
  asw_votes       INT DEFAULT 0         NOT NULL,
  asw_content     LONGVARCHAR           NOT NULL,
...
CREATE TABLE question (
  ...
  qs_id      BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
  qs_user_id INT          NOT NULL,
  qs_name    VARCHAR(200) NOT NULL,
  qs_votes   INT          NOT NULL,
  qs_content LONGVARCHAR  NOT NULL,
...
CREATE TABLE question_tag (
  ...
  qt_id          BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,
