...
CREATE TABLE badge (
  ...
  bdg_id   INT GENERATED BY DEFAULT AS IDENTITY (
  START WITH 1 ) PRIMARY KEY,
...
CREATE TABLE answer (
  ...
  asw_id          INT GENERATED BY DEFAULT AS IDENTITY (
  START WITH 1 ) PRIMARY KEY,
...
CREATE TABLE question (
  ...
  qs_id      INT GENERATED BY DEFAULT AS IDENTITY (
  START WITH 1 ) PRIMARY KEY,
...
CREATE TABLE question_tag (
  ...
  qt_id          INT GENERATED BY DEFAULT AS IDENTITY (
  START WITH 1 ) PRIMARY KEY,
