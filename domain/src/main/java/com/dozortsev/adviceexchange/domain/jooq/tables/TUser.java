...
public class TUser extends org.jooq.impl.TableImpl<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserRecord> {

	private static final long serialVersionUID = -42413427;

	/**
	 * The singleton instance of <code>adviceexchange.user</code>
	 */
	public static final com.dozortsev.adviceexchange.domain.jooq.tables.TUser USER = new com.dozortsev.adviceexchange.domain.jooq.tables.TUser();
	...
	public TUser(java.lang.String alias) {
		this(alias, com.dozortsev.adviceexchange.domain.jooq.tables.TUser.USER);
	}

	private TUser(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserRecord> aliased) {
		this(alias, aliased, null);
	}

	private TUser(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public com.dozortsev.adviceexchange.domain.jooq.tables.TUser as(java.lang.String alias) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.TUser(alias, this);
	}

	/**
	 * Rename this table
	 */
	public com.dozortsev.adviceexchange.domain.jooq.tables.TUser rename(java.lang.String name) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.TUser(name, null);
	}
}
