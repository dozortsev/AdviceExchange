...
public class Tag extends org.jooq.impl.TableImpl<com.dozortsev.adviceexchange.domain.jooq.tables.records.TagRecord> {
	 ...
	 */
	public static final com.dozortsev.adviceexchange.domain.jooq.tables.Tag TAG = new com.dozortsev.adviceexchange.domain.jooq.tables.Tag();
	...
	public Tag(java.lang.String alias) {
		this(alias, com.dozortsev.adviceexchange.domain.jooq.tables.Tag.TAG);
	}

	private Tag(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.TagRecord> aliased) {
		this(alias, aliased, null);
	}

	private Tag(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.TagRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public com.dozortsev.adviceexchange.domain.jooq.tables.Tag as(java.lang.String alias) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.Tag(alias, this);
	}

	/**
	 * Rename this table
	 */
	public com.dozortsev.adviceexchange.domain.jooq.tables.Tag rename(java.lang.String name) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.Tag(name, null);
	}
}
