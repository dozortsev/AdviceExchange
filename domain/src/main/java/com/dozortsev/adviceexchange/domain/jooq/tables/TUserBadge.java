...
public class TUserBadge extends org.jooq.impl.TableImpl<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserBadgeRecord> {

	private static final long serialVersionUID = 1738511635;

	/**
	 * The singleton instance of <code>adviceexchange.user_badge</code>
	 */
	public static final com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge USER_BADGE = new com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge();
	 ...
	 */
	public TUserBadge(java.lang.String alias) {
		this(alias, com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge.USER_BADGE);
	}

	private TUserBadge(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserBadgeRecord> aliased) {
		this(alias, aliased, null);
	}

	private TUserBadge(java.lang.String alias, org.jooq.Table<com.dozortsev.adviceexchange.domain.jooq.tables.records.UserBadgeRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge as(java.lang.String alias) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge(alias, this);
	}

	/**
	 * Rename this table
	 */
	public com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge rename(java.lang.String name) {
		return new com.dozortsev.adviceexchange.domain.jooq.tables.TUserBadge(name, null);
	}
}
